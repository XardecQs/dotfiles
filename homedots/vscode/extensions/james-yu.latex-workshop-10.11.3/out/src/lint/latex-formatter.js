...
const quote_fixer_1 = require("../extras/quote-fixer");
...
class FormattingProvider {
    ...
    async provideDocumentFormattingEdits(document, _options, _token) {
        ...
        const finalEdit = (0, quote_fixer_1.fixQuotes)(document, undefined, edit);
    ...
    async provideDocumentRangeFormattingEdits(document, range, _options, _token) {
        ...
        if (edit === undefined) {
            const fixedQuoteEdit = (0, quote_fixer_1.fixQuotes)(document, range, undefined);
        ...
        const finalEdit = (0, quote_fixer_1.fixQuotes)(document, range, edit);
        if (finalEdit === undefined) {
            return [];
        }
        return [finalEdit];
